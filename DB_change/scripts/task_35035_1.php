...
$aIblockProperties = array(
    [
        ...
        "NAME"                  => "Фильтровать в каталоге по Новосибирской цене",
        "CODE"                  => "FILTER_SIB_PRICE",
        "SORT"                  => "400",
        "HINT"                  => "Если включено, то в каталоге фильтрация происходит по свойству MINIMUM_PRICE_SIB",
        "PROPERTY_TYPE"         => "L",
        "LIST_TYPE"             => "C",
        "ITEMS"                 => [
            [
