...
$aIblockProperties = array(
    [
        "IBLOCK_ID"             => $aCosmosConfigIblock["discount_optim"]["ID"],
        "NAME"                  => "Скидка (%)",
        "CODE"                  => "SKIDKA",
        "SORT"                  => "100",
        "IS_REQUIRED"           => "Y",
    ...
    [
        ...
        "SORT"                  => "200",
        "MULTIPLE"              => "Y",
        "HINT"                  => "Если выбран один или несколько разделов, то скидка распространяется на все элементы выбраных разделов.",
        "PROPERTY_TYPE"         => "G",
    ...
    [
        "IBLOCK_ID"             => $aCosmosConfigIblock["discount_optim"]["ID"],
        "NAME"                  => "Отключить декоративную скидку",
        "CODE"                  => "OFF_DECOR_SKIDKA",
        "SORT"                  => "400",
        "HINT"                  => "Если включено, то убирает декоративную скидку у выбранных товаров/разделов.",
        "PROPERTY_TYPE"         => "L",
        "LIST_TYPE"             => "C",
        "ITEMS"                 => [
            [
