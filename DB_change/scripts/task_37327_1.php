...
$aIblockProperties = array(
    [
        ...
        "NAME"                  => "Есть подсветка у товара",
        "CODE"                  => "IS_BACKLIGHT",
        "SORT"                  => "400",
        "HINT"                  => "Если включено в товаре, то выводится в дет. карточке подсветка (берется из аксессуаров)",
        "PROPERTY_TYPE"         => "L",
        "LIST_TYPE"             => "C",
        "ITEMS"                 => [
            [
    ...
    [
        "IBLOCK_ID"             => $aCosmosConfigIblock["1c_catalog"]["ID"],
        "NAME"                  => "Является подсветкой Аксессуар",
        "CODE"                  => "IS_BACKLIGHT_TRUE",
        "SORT"                  => "400",
        "HINT"                  => "Если включено в товаре, то является подсветкой",
        "PROPERTY_TYPE"         => "L",
        "LIST_TYPE"             => "C",
        "ITEMS"                 => [
            [
    ...
    [
        "IBLOCK_ID"             => $aCosmosConfigIblock["1c_catalog"]["ID"],
        "NAME"                  => "Картинка Аксессуара",
        "CODE"                  => "IMAGE_ACCESSORY",
        "SORT"                  => "400",
        "HINT"                  => "Задается для отображения в детальной карточке товара (как дополнение у шкафа)",
        "PROPERTY_TYPE"         => "F",
    ],
