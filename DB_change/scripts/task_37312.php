...
$aIblockProperties = array(
    [
        ...
        "NAME"                  => "Отображать вариант доставки \"Деловые линии\"",
        "CODE"                  => "SHOW_DELIVERY_BUSINESS_LINE",
        "SORT"                  => "400",
        "HINT"                  => "Если включено, то отображается вариант доставки \"Деловые линии\"",
        "PROPERTY_TYPE"         => "L",
        "LIST_TYPE"             => "C",
        "ITEMS"                 => [
            [
    ...
    [
        "IBLOCK_ID"             => $aCosmosConfigIblock["aspro_max_regions"]["ID"],
        "NAME"                  => "Отображать вариант доставки \"Собственная служба доставки\"",
        "CODE"                  => "SHOW_OWN_DELIVERY",
        "SORT"                  => "400",
        "HINT"                  => "Если включено, то отображается вариант доставки \"Собственная служба доставки\"",
        "PROPERTY_TYPE"         => "L",
        "LIST_TYPE"             => "C",
        "ITEMS"                 => [
            [
    ...
    [
        "IBLOCK_ID"             => $aCosmosConfigIblock["aspro_max_regions"]["ID"],
        "NAME"                  => "Отображать вариант доставки \"Самовывоз\"",
        "CODE"                  => "SHOW_PICKUP",
        "SORT"                  => "400",
        "HINT"                  => "Если включено, то отображается вариант доставки \"Самовывоз\"",
        "PROPERTY_TYPE"         => "L",
        "LIST_TYPE"             => "C",
        "ITEMS"                 => [
            [
