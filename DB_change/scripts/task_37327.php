...
$aIblockProperties = [
    [
        "IBLOCK_ID" => Config::getInstance()->getIblockIdByCode('1c_catalog'),
        "NAME" => "Серия акссессуара (для привязки товара к ассессуару по серии)",
        "CODE" => "SERIYA_AKSECCUAR",
        "PROPERTY_TYPE" => "L",
        "LIST_TYPE"     => "C",
        "MULTIPLE" => "Y",
        "ITEMS" => [
            ...
            [
                "VALUE" => "Экспресс угловой шкаф",
                "XML_ID" => "express_ygl_shkaf",
            ],
            [
                "VALUE" => "Леруа двери",
                "XML_ID" => "lerya",
