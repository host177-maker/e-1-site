...
$APPLICATION->SetPageProperty("description", "Каталог мебели для вашего идеального пространства: стильные и функциональные шкафы-купе и гардеробные. Посмотрите наш ассортимент и выберите то, что подходит именно вам!.");
$APPLICATION->SetPageProperty("title", "Каталог шкафов-купе от производителя Е1, шкафы-купе {IN_CITY} – под заказ и в наличии с доставкой");
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => !empty($_SERVER['REDIRECT_REGION']) ? "/{$_SERVER['REDIRECT_REGION']}/catalog/" : "/catalog/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		...
		"SORT_BUTTONS" => array(
			0 => "POPULARITY",
			//1 => "NAME",//По алфавиту по возрастанию;По алфавиту по убыванию.
			2 => "PRICE",
		),
		...
		"OFFERS_SORT_FIELD" => COrwoFunctions::$arDefOffersSort["OFFERS_SORT_FIELD"],
		"OFFERS_SORT_ORDER" => COrwoFunctions::$arDefOffersSort["OFFERS_SORT_ORDER"],
		"OFFERS_SORT_FIELD2" => COrwoFunctions::$arDefOffersSort["OFFERS_SORT_FIELD2"],
		"OFFERS_SORT_ORDER2" => COrwoFunctions::$arDefOffersSort["OFFERS_SORT_ORDER2"],
		"PAGER_TEMPLATE" => "main",
		"DISPLAY_TOP_PAGER" => "N",
		...
		"PAGER_SHOW_ALL" => "N",
		"IBLOCK_STOCK_ID" => "25",
		"IBLOCK_LINK_NEWS_ID" => "21",
		"IBLOCK_SERVICES_ID" => "23",
		"IBLOCK_TIZERS_ID" => "11",
		"IBLOCK_LINK_REVIEWS_ID" => "20",
		"STAFF_IBLOCK_ID" => "17",
		"VACANCY_IBLOCK_ID" => "3",
		"SHOW_QUANTITY" => "Y",
		"SHOW_MEASURE" => "N",
		...
		"SHOW_DELIVERY" => "Y",
		"TITLE_DELIVERY" => "Оплата и Доставка",
		"SHOW_PAYMENT" => "N",
		...
		"LANDING_IBLOCK_ID" => "30",
		"DETAIL_BLOCKS_TAB_ORDER" => "desc,char,instructions,delivery,stores,video,our_work,reviews,buy,payment,custom_tab,ar,3d",
		...
		"OFFER_TREE_PROPS" => array(
			...
			4 => "HOUSING_LAYOUT",
			5 => "TSVET_PROFILYA",
			6 => "VARIANT_ISPOLNENIYA",
		),
		"TAB_BUY_SERVICES_NAME" => "",
		"COUNT_SERVICES_IN_ANNOUNCE" => "1",
