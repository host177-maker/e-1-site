...
class ORDER_CUSTOM_CABINET20250806163138 extends Version
{
    ...
    public function up()
    {
        ...
        $helper->Event()->saveEventType('FORM_FILLING_ORDER_CUSTOM_CABINET', array (
  'LID' => 'ru',
  'EVENT_TYPE' => 'email',
  'NAME' => 'Заполнена web-форма "ORDER_CUSTOM_CABINET"',
...
',
  ...
  'LID' => 'en',
  'EVENT_TYPE' => 'email',
  'NAME' => 'Web form filled "ORDER_CUSTOM_CABINET"',
...
',
  'SORT' => '100',
            ...
            $helper->Event()->saveEventMessage('FORM_FILLING_ORDER_CUSTOM_CABINET', array (
  'LID' => 
  array (
    0 => 's1',
  ),
...
Письмо сгенерировано автоматически.
  ...
  'LANGUAGE_ID' => NULL,
  'EVENT_TYPE' => '[ FORM_FILLING_ORDER_CUSTOM_CABINET ] Заполнена web-форма "ORDER_CUSTOM_CABINET"',
));
        }
}
