...
// theme
Option::set('aspro.max', "THEME_SWITCHER", "N", WIZARD_SITE_ID);
Option::set('aspro.max', "BASE_COLOR", WIZARD_THEME_ID, WIZARD_SITE_ID);
Option::set('aspro.max', "THEMATIC", WIZARD_THEMATIC, WIZARD_SITE_ID);
