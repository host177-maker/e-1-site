...
$MESS["UF_LINKED_BANNERS"] = "Связанные статьи";
$MESS["UF_BANNERS_WIDE"] = "Номер строки товаров, после которой отображать связанные статьи (>768px)";
$MESS["UF_BANNERS_BOTTOM"] = "Перенести связанные статьи из списка товаров в блок перед SEO-описанием";
$MESS["UF_BANNERS_MOBILE"] = "Номер строки товаров, после которой отображать связанные статьи (<768px)";
?>