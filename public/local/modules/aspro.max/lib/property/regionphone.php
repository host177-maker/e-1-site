				...
				<div class="inner_wrapper">
					<div class="inner">
						<div class="value_wrapper">
							<input type="text" name="<?=$phoneName?>" value="<?=htmlspecialcharsbx($phone)?>" maxlength="255" placeholder="<?=Loc::getMessage('MAX_REGION_PHONE_PHONE_TITLE')?>" />
						</div>
					</div>
					<div class="inner">
						<div class="value_wrapper">
							<input type="text" name="<?=$hrefName?>" value="<?=htmlspecialcharsbx($href)?>" maxlength="255" placeholder="<?=Loc::getMessage('MAX_REGION_PHONE_HREF_TITLE')?>" />
						</div>
					</div><br />
					<div class="inner">
						<div class="value_wrapper">
					...
					<div class="inner">
						<div class="value_wrapper">
							<?if($bWithDescription):?>
								<input type="text" name="<?=$descriptionName?>" value="<?=htmlspecialcharsbx($description)?>" maxlength="255" placeholder="<?=Loc::getMessage('MAX_REGION_PHONE_DESCRIPTION_TITLE')?>" <?=($bEditProperty ? 'readonly disabled' : '')?> />
							<?else:?>
