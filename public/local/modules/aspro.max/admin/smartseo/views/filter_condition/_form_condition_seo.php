...
?>
<form id="form_seo_property_filter_condition_<?= $_suffix ?>" method="POST" action="<?= Helper::url('filter_rule_detail/update') ?>">
        ...
        <td width="100%">
          <div class="aspro-smartseo__form-control__fieldset">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div page-role="control-engine-template" data-state="<?= $dataSeo['META_TITLE']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div page-role="control-engine-template" data-state="<?= $dataSeo['META_KEYWORDS']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
                <div class="aspro-smartseo__form-control__label">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div page-role="control-engine-template" data-state="<?= $dataSeo['META_DESCRIPTION']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
                <div class="aspro-smartseo__form-control__label">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div page-role="control-engine-template" data-state="<?= $dataSeo['PAGE_TITLE']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
                <div class="aspro-smartseo__form-control__label">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div page-role="control-engine-template" data-state="<?= $dataSeo['BREADCRUMB_PAGE']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
                <div class="aspro-smartseo__form-control__label">
          ...
          <div class="aspro-smartseo__form-control__fieldset">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div page-role="control-engine-template" data-state="<?= $dataSeo['TOP_DESCRIPTION']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
                <div class="aspro-smartseo__form-control__label">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
                <div page-role="control-engine-template" data-state="<?= $dataSeo['BOTTOM_DESCRIPTION']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
                  <div class="aspro-smartseo__form-control__label">
            ...
            <div class="aspro-smartseo__form-control aspro-smartseo__form-control--mb aspro-smartseo__form-control--w100">
              <div page-role="control-engine-template" data-state="<?= $dataSeo['ADDITIONAL_DESCRIPTION']['ENTITY_TYPE'] != 'FC' ? 'false' : '' ?>">
                <div class="aspro-smartseo__form-control__label">
