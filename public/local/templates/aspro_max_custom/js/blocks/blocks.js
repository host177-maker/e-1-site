...
$(document).ready(function(){
	...
	if(!('SelectOfferProp' in window) && typeof window.SelectOfferProp != 'function')
	{
		SelectOfferProp = function(){
			...
			let $currentPriceHtml = _this.parents('.item_info').find('.js_price_wrapper .price_matrix_wrapper').html();
			...
			$.ajax({
				...
				if ($currentPriceHtml) {
					_this.parents('.item_info').find('.js_price_wrapper .price_matrix_wrapper').html($currentPriceHtml);
				}
			})
		}
