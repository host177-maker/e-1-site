<?
	...
	$MESS['SELECTION_WARDROBE'] = 'Заказать подбор';
	$MESS['SELECTION_WARDROBE_DDESCRIPTION'] = 'Подберём 3 варианта шкафа под ваш бюджет и интерьер - бесплатно!';
	$MESS['SELECTION_ORDER_BUTTON'] = 'Заказать подбор';
?>