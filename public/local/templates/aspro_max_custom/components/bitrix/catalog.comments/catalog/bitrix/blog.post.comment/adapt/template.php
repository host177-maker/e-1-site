								...
								<div class="form blog-comment-fields">
									<div class="blog-comment-field blog-comment-field-user">
										<div class="row form">
											...
											<div class="col-md-4 col-sm-4">
												<div class="form-group animated-labels <?= ($_SESSION["blog_user_phone"] ? 'input-filed' : ''); ?>">
													<label for="user_phone">Телефон <span class="required-star">*</span></label>
													<div class="input">
														<input maxlength="255" size="30" class="form-control phone" tabindex="5" type="tel" name="user_phone" id="user_phone" value="<?= htmlspecialcharsEx($_SESSION["blog_user_phone"]) ?>">
													</div>
												</div>
											</div>
										</div>
									...
									<script>
										if(arMaxOptions['THEME']['PHONE_MASK'].length){
											...
											$('form[name=form_comment] input.phone').inputmask('mask', {'mask': arMaxOptions['THEME']['PHONE_MASK'] });
											$('form[name=form_comment] input.phone').blur(function(){
										...
										<div class="row form">
											<div class="col-md-6 col-sm-6">
												<div class="form-group animated-labels  input-filed">
													<label for="user_name"><?= GetMessage("B_B_MS_ORDER_ID") ?> <span class="required-star">*</span></label>
													<div class="input">
														<input maxlength="255" size="30" class="form-control" tabindex="3" type="text" name="user_order_id" id="user_order_id" value="<?= htmlspecialcharsEx($_SESSION["user_order_id"]) ?>">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="row form files">
										<div class="col-md-12">
											<div class="form-group">
												<div class="input">
													<input type="file" multiple class="form-control" tabindex="3" name="comment_images1[]" id="comment_images1" value="">
												</div>
											</div>
										</div>
									</div>
									<div class="row form files">
										<div class="col-md-12">
											<div class="form-group">
												<div class="input">
													<input type="file" multiple class="form-control" tabindex="3" name="comment_images2[]" id="comment_images2" value="">
												</div>
											</div>
										</div>
									</div>
					...
					<div class="blog-comment <?= $tabCount > 0 || $comment['PARENT_ID'] ? 'child' : 'parent bordered rounded3' ?>" style="padding-left:calc(<?= $startVal ?>px + <?= $paddingSize ?>px);">
						<div id="blg-comment-<?= $comment["ID"] ?>">
							...
							?>
												...
												<div class="comment-image__wrapper">
													...
													<? foreach ($comment['IMAGES'] as $arImg): ?>
														<? if ($arImg['FILE_ID']): ?>
															...
															<a class="comment-image fancy" data-fancybox="<?= 'comment-' . $comment['ID'] . 'gallery' ?>" href="<?= CFile::GetPath($arImg['FILE_ID']) ?>">
																<img src="<?= $smalImage ?>">
															</a>
														<? endif; ?>
													<? endforeach; ?>
								...
								<?
									if (
										strlen($errorComment) <= 0 && (strlen($_POST["preview"]) > 0 && $_POST["show_preview"] != "N") && (IntVal($_POST["parentId"]) > 0 || IntVal($_POST["edit_id"]) > 0)
