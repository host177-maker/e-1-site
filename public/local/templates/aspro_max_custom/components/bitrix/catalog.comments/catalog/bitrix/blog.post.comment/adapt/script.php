...
if(!isNaN(rating_value) && rating_value !== undefined && rating_value) {
	...
	$('.right_reviews_info_duble').find('.rating-value .count').text(rating_value);
	rating_value = Math.round(rating_value);
	var maximum = $('.tab-pane.reviews.EXTENDED .rating-value .maximum_value');
	var maximum2 = $('.right_reviews_info_duble .maximum_value');
	if(maximum.length) {
		maximum.text('/5');
	}
	if(maximum2.length) {
	...
	var stars_duble = $('.right_reviews_info_duble').find('.item-rating');
	if(stars.length) {
