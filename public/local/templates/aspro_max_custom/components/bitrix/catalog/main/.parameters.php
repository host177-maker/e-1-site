...
$arTemplateParametersParts[] = array(
	'DETAIL_BLOCKS_TAB_ORDER' => array(
		...
		'DEFAULT' => 'desc,char,buy,payment,delivery,video,stores,reviews,custom_tab,buy_services'
	)
);
$arTemplateParametersParts[] = array(
	'DETAIL_BLOCKS_ALL_ORDER' => array(
		...
		'DEFAULT' => 'complect,nabor,offers,desc,char,buy,payment,delivery,video,stores,buy_services,custom_tab,services,news,reviews,blog,staff,vacancy,gifts,goods'
	)
);
