								...
								<div class="body-info">
									...
									<?if($arItem['DISPLAY_PROPERTIES']['FILE']['VALUE']):?>
										<div class="photo-gallery-block">
											<div class="row flexbox flexbox--row photo-gallery-block-body">
												<?foreach((array)$arItem['DISPLAY_PROPERTIES']['FILE']['VALUE'] as $arFileItem):?>
													<?//$arFile=CMax::GetFileInfo($arFileItem);?>
													<?$arPreviewPhoto = CFile::ResizeImageGet($arFileItem, array('width' => 200, 'height' => 200), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
													<?$arPreviewDetail = CFile::ResizeImageGet($arFileItem, array('width' => 1000, 'height' => 1000), BX_RESIZE_IMAGE_PROPORTIONAL, true);?>
													<div class="col-xs-12 col-sm-3 photo-gallery-item">
														<div class="photo-gallery-item-body">
															<a href="<?=$arPreviewDetail["src"];?>" data-fancybox="photo-gallery" class="fancy">
																<img class="picture lazy" border="0" src="<?=$arPreviewPhoto["src"];?>">
															</a>
														</div>
													</div>
												<?endforeach;?>
