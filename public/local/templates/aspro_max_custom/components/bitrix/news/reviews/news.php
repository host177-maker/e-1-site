...
<?if($arParams["SHOW_ADD_REVIEW_BUTTON"] == "Y"):?>
	<div class="add_review">
		<div class="button_wrap">
			<span><span class="btn btn-default btn-lg animate-load" data-event="jqm" data-param-form_id="GIVE_FEEDBACK" data-name="send_review"><?=(strlen($arParams["ADD_REVIEW_BUTTON"]) ? $arParams["ADD_REVIEW_BUTTON"] : GetMessage('ADD_REVIEW'))?></span></span>
		</div>
	</div>
<?endif;?>
