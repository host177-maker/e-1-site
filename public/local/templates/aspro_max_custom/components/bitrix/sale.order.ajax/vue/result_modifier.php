...
//формируем данные для ecommerce события "purchase"
/*$arEcomData = [];
$arEcomData['transaction_id'] = $arResult['ORDER']['ID'];
$arEcomData['value'] = $arResult['ORDER']['PRICE'];
$arEcomData['tax'] = $arResult['ORDER']['TAX_VALUE'];
$arEcomData['shipping'] = $arResult['ORDER']['PRICE_DELIVERY'];
$arEcomData['currency'] = $arResult['ORDER']['CURRENCY'];
...
$arResult['ORDER_ECOM_DATA'] = $arEcomData;*/
