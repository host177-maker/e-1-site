...
$MESS['TAB_GALLERY_NAME'] = 'Фото';
$MESS['TAB_FILES_NAME'] = 'Инструкции по сборке';
$MESS['CONFIGURATION_INFO_TITLE'] = 'Конфигурация';
$MESS['CONFIGURATION_CHANGE_TITLE'] = 'Изменить дизайн';
$MESS['SLIDING_WARDROBE_PARAMETERS_TITLE'] = 'Параметры шкафа-купе';
$MESS['3DMODEL_TITLE'] = '3D модель';
$MESS['ARMODEL_TITLE'] = 'AR примерялка';
$MESS['OUR_WORK'] = 'Наши работы';
?>