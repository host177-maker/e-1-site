...
window.JCCatalogElement.prototype.ChangeInfo = function()
{
	...
	if (-1 < index)
	{
		...
		*/
		...
		console.log(this.offers[index]['SERVICES']);
		...
		if(servWrap.length && typeof(itemObjServices) !== 'undefined'){			
			...
			servWrap.find('.services-item').each(function (){
				...
				if(typeof(itemObjServices[serviceCode]) !== 'undefined'){
					serviceItem.find('.price_value').html(itemObjServices[serviceCode]['VALUE']);
					serviceItem.attr('data-price', itemObjServices[serviceCode]['VALUE']);
