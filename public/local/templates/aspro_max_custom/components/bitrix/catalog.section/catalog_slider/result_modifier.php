...
// echo '<div style="display:none; font-size: 16px;" class="myDump $arMatrix"><pre>';
// 	print_r($arMatrix);
// echo '</pre></div>';

// echo '<div style="display:none; font-size: 16px;" class="myDump $arSKUPropList"><pre>';
// 	print_r($arOffer['DISPLAY_PROPERTIES']['BASIC_CONFIGURATION']);
// echo '</pre></div>';
...
// echo '<div style="display:none; font-size: 16px;" class="myDump $arPropSKU"><pre>';
// 	print_r($arPropSKU);
// echo '</pre></div>';
...
// echo '<div style="display:none; font-size: 16px;" class="myDump $arSortFields"><pre>';
// 	print_r($arSortFields);
// echo '</pre></div>';
