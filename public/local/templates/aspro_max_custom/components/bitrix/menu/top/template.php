					...
					<td class="menu-item unvisible <?=($arItem["CHILD"] ? "dropdown" : "")?> <?=(isset($arItem["PARAMS"]["CLASS"]) ? $arItem["PARAMS"]["CLASS"] : "");?>  <?=($arItem["SELECTED"] ? "active" : "")?>">
						<div class="wrap">
							<?if(empty($arItem["LINK"])):?>
								<div class="menu-item-body <?=($arItem["CHILD"] && $bShowChilds ? "dropdown-toggle" : "")?>">
							<?else:?>
								<a <?= ($arItem['PARAMS']['formaction'] ? 'data-event="jqm" data-param-form_id="' . $arItem['PARAMS']['formaction'] . '" data-name="' . $arItem['PARAMS']['formaction'] . '"' : ""); ?> class="<?=($arItem["CHILD"] && $bShowChilds ? "dropdown-toggle" : "")?>" href="<?=$arItem["LINK"]?>">
							<?endif;?>
								<div>
													...
													<div class="menu-navigation__sections">
														<?foreach($arItem["CHILD"] as $arChild):?>
															<div class="menu-navigation__sections-item<?=($arChild['SELECTED'] ? " active" : "");?>">
																...
																<?if(empty($arChild["LINK"])):?>
																	<div class="menu-navigation__sections-item-link font_xs colored_theme_text <?=($bShowImg ? " menu-navigation__sections-item-link--image" : "");?><?=($arChild['CHILD'] ? " menu-navigation__sections-item-dropdown" : "");?>"
																	>
																<?else:?>
																	<a <?= ($arItem['PARAMS']['formaction'] ? 'data-event="jqm" data-param-form_id="' . $arItem['PARAMS']['formaction'] . '" data-name="' . $arItem['PARAMS']['formaction'] . '"' : ""); ?> href="<?=$arChild['LINK']?>" class="menu-navigation__sections-item-link font_xs <?=($arChild["SELECTED"] ? "colored_theme_text" : "dark_link")?> <?=($bShowImg ? " menu-navigation__sections-item-link--image" : "");?><?=($arChild['CHILD'] ? " menu-navigation__sections-item-dropdown" : "");?>"
																	>
																<?endif;?>
																	<?if($arChild['CHILD']):?>
