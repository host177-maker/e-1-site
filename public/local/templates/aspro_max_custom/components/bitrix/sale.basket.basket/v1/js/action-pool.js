;(function(){
	...
	BX.Sale.BasketActionPool.prototype.doProcessing = function(state)
	{
		...
		if (this.requestProcessing)
		{
			...
			if (this.changedSKUid){
				$(`#basket-item-${this.changedSKUid}`).addClass('loading_block')
			}
		}
		else
		{
			if (this.changedSKUid){
				$(`#basket-item-${this.changedSKUid}`).removeClass('loading_block')
				this.changedSKUid = '';
			}
