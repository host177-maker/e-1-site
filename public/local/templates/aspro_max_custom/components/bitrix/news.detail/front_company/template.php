								...
								<div class="text">
									...
									<? else : ?>
										<? if (isset($arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']) && $arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']['VALUE']) : ?>
											<h1><?= $arResult['DISPLAY_PROPERTIES']['COMPANY_NAME']['VALUE']; ?></h1>
										<? endif; ?>
									...
									<div class="znak_container">
										<a href="https://производительность.рф/" target="_blank"><img src="<?= $templateFolder ?>/images/productivity.png" /></a>
									</div>
										...
										<div class="play">
											<div class="fancy" rel="nofollow">
												<? if ($videoPlayer == 'HTML5') : ?>
													<video id="company_video" muted playsinline controls loop>
														<source class="video-block" src="#" data-src="<?= $videoPlayerSrc; ?>" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"' />
													</video>
												<? else : ?>
