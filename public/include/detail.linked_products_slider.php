...
if($arRegion)
{
	...
	if($catalogID = \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", \Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", '27')))
	{
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PROPERTY_CODE" => $arParams['LINKED_PROPERTY_CODE'],
		"OFFERS_LIMIT" => "10",
		"SECTION_URL" => "",
		"DETAIL_URL" => "",
		...
		"BLOCK_TITLE" => $sLinkedSliderTitle
	),
