...
$APPLICATION->SetPageProperty("description", "Особенности шкафов-купе: от компактного дизайна до эргономичности. Узнайте, как они помогут создать порядок и стиль в вашем доме.");
$APPLICATION->SetPageProperty("title", "Полезные советы от специалистов E1");
...
?><?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"CHECK_DATES" => "Y",
		"SEF_MODE" => "Y",
		"SEF_FOLDER" => "/client/features/blog/",
		"AJAX_MODE" => "N",
		"AJAX_OPTION_JUMP" => "N",
		"AJAX_OPTION_STYLE" => "Y",
		...
		"IBLOCK_LINK_SERVICES_ID" => "23",
		"IBLOCK_LINK_TIZERS_ID" => "11",
		"IBLOCK_LINK_REVIEWS_ID" => "20",
		"IBLOCK_LINK_STAFF_ID" => "17",
		"IBLOCK_LINK_VACANCY_ID" => "3",
		"IBLOCK_LINK_BLOG_ID" => "18",
		"IBLOCK_LINK_PROJECTS_ID" => "16",
		"IBLOCK_LINK_BRANDS_ID" => "31",
		"IBLOCK_LINK_LANDINGS_ID" => "18",
