    ...
    <div className="bg-white">
      ...
      <div className="container-custom py-10">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          {/* Production image */}
          <div
            className="relative h-[280px] rounded-lg overflow-hidden bg-[#f5f5f5] bg-cover bg-center"
            style={{ backgroundImage: "url('/images/production-line.jpg')" }}
          >
            {/* Placeholder показывается только если нет картинки (как фон под картинкой) */}
          </div>
