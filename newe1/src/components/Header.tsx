    ...
    <header className="bg-white sticky top-0 z-50 shadow-sm">
      ...
      <div className="container-custom">
        <div className="flex items-center justify-between py-3 gap-4">
          ...
          {/* City selector */}
          <div className="hidden md:flex items-center gap-1 text-sm text-text-dark shrink-0 cursor-pointer hover:text-[#62bb46]">
            <span>Москва</span>
          ...
          <div className="hidden xl:flex items-center gap-2 shrink-0">
            <a href="#" className="w-8 h-8 bg-[#0088cc] rounded flex items-center justify-center text-white hover:opacity-80" title="Telegram">
            ...
            <a href="#" className="w-8 h-8 bg-[#25D366] rounded flex items-center justify-center text-white hover:opacity-80" title="WhatsApp">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="hidden 2xl:flex flex-col text-xs text-text-muted shrink-0">
            <span>Напишите нам</span>
            <a href="tel:+79384222111" className="text-text-dark hover:text-[#62bb46] font-medium">+7 (938) 422-21-11</a>
          </div>
