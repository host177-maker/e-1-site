        ...
        <div className="container-custom">
          <div className="flex items-center justify-between py-1.5 text-xs">
            ...
            <div className="hidden lg:flex items-center gap-4 xl:gap-6">
              {/* City selector */}
              <button className="flex items-center gap-1 hover:text-[#62bb46] transition-colors">
              ...
              {/* Sales badge */}
              <Link href="/sales" className="flex items-center gap-1 hover:text-[#62bb46] transition-colors">
            ...
            <div className="hidden lg:flex items-center gap-2 ml-auto">
              ...
              <a href="tel:+78001001211" className="font-medium hover:text-[#62bb46] transition-colors">
                8-800-100-12-11
              </a>
            </div>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="lg:hidden flex items-center gap-1 hover:text-[#62bb46] transition-colors"
            >
              <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
              </svg>
            ...
            {/* Mobile: phone */}
            <a href="tel:+78001001211" className="lg:hidden font-medium hover:text-[#62bb46] transition-colors">
              8-800-100-12-11
            </a>
          </div>
        </div>
      ...
      <div className="bg-white border-b border-gray-100">
        <div className="container-custom">
          <div className="flex items-center py-2.5 gap-3 xl:gap-4">
            ...
            <Link
              href="/catalog"
              className="hidden lg:flex items-center gap-2 px-4 py-2 bg-[#62bb46] text-white font-semibold rounded hover:bg-[#55a83d] transition-colors text-sm ml-2"
            >
            ...
            <div className="flex items-center gap-1.5 shrink-0 ml-auto lg:ml-0">
              ...
              {/* VK */}
              <a href="https://vk.com/e1furniture" target="_blank" rel="noopener noreferrer" className="w-8 h-8 bg-[#4c75a3] rounded flex items-center justify-center text-white hover:bg-[#3d6291] transition-colors" title="ВКонтакте">
                <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="hidden sm:flex items-center gap-0.5">
              {/* Compare */}
              <Link href="/compare" className="flex flex-col items-center justify-center w-12 h-12 hover:text-[#62bb46] transition-colors relative">
              ...
              {/* Wishlist */}
              <Link href="/wishlist" className="flex flex-col items-center justify-center w-12 h-12 hover:text-[#62bb46] transition-colors relative">
                <svg className="w-6 h-6 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <Link href="/cart" className="sm:hidden flex flex-col items-center justify-center w-10 h-10 hover:text-[#62bb46] transition-colors relative">
              ...
              <span className="absolute top-0 right-0 bg-[#62bb46] text-white text-[10px] font-medium rounded-full min-w-[18px] h-[18px] flex items-center justify-center px-1">0</span>
            </Link>
          </div>
        </div>
      </div>
