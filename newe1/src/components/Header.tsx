        ...
        <div className="container-custom">
          <div className="flex items-center py-2.5 gap-3 xl:gap-4">
            ...
            <Link href="/" className="flex items-center gap-1.5 shrink-0">
              <Logo />
              <div className="hidden sm:flex flex-col text-[#62bb46] font-bold text-base leading-[1.1] tracking-wide">
                <span>ШКАФЫ</span>
                <span>КУПЕ</span>
              </div>
            </Link>
            ...
            <div className="hidden xl:flex items-center gap-1.5 shrink-0">
              {/* Telegram */}
              <a href="#" className="w-8 h-8 bg-[#54a9eb] rounded flex items-center justify-center text-white hover:bg-[#3d96d9] transition-colors" title="Telegram">
                <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M9.78 18.65l.28-4.23 7.68-6.92c.34-.31-.07-.46-.52-.19L7.74 13.3 3.64 12c-.88-.25-.89-.86.2-1.3l15.97-6.16c.73-.33 1.43.18 1.15 1.3l-2.72 12.81c-.19.91-.74 1.13-1.5.71L12.6 16.3l-1.99 1.93c-.23.23-.42.42-.83.42z"/>
                </svg>
              </a>
              {/* WhatsApp */}
              <a href="#" className="w-8 h-8 bg-[#60d669] rounded-full flex items-center justify-center text-white hover:bg-[#4bc054] transition-colors" title="WhatsApp">
                <svg className="w-[18px] h-[18px]" viewBox="0 0 24 24" fill="currentColor">
