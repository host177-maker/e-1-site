        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div>
            ...
            <div className="flex gap-2 mb-2">
              <a href="#" className="w-10 h-10 bg-[#4d4d4d] rounded flex items-center justify-center text-gray-300 hover:bg-[#62bb46] hover:text-white transition-colors" title="WhatsApp">
              ...
              <a href="#" className="w-10 h-10 bg-[#4d4d4d] rounded flex items-center justify-center text-gray-300 hover:bg-[#62bb46] hover:text-white transition-colors" title="Одноклассники">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#" className="w-10 h-10 bg-[#4d4d4d] rounded flex items-center justify-center text-gray-300 hover:bg-[#62bb46] hover:text-white transition-colors" title="Telegram">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex gap-2">
              <a href="#" className="w-10 h-10 bg-[#4d4d4d] rounded flex items-center justify-center text-gray-300 hover:bg-[#62bb46] hover:text-white transition-colors" title="ВКонтакте">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#" className="w-10 h-10 bg-[#4d4d4d] rounded flex items-center justify-center text-gray-300 hover:bg-[#62bb46] hover:text-white transition-colors" title="Яндекс.Дзен">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
              ...
              <a href="#" className="w-10 h-10 bg-[#4d4d4d] rounded flex items-center justify-center text-gray-300 hover:bg-[#62bb46] hover:text-white transition-colors" title="Одноклассники">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 4.8c1.98 0 3.6 1.62 3.6 3.6s-1.62 3.6-3.6 3.6-3.6-1.62-3.6-3.6 1.62-3.6 3.6-3.6zm0 14.4c-2.58 0-4.86-1.32-6.18-3.3.06-2.04 4.14-3.18 6.18-3.18s6.12 1.14 6.18 3.18c-1.32 1.98-3.6 3.3-6.18 3.3z"/>
                </svg>
              </a>
            </div>
          </div>
