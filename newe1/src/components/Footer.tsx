        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/service/production-time" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Сроки изготовления</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/service/faq" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Вопросы и ответы</Link></li>
              <li><Link href="/service/tips" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Советы от Е1</Link></li>
              <li><Link href="/service/portfolio" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Наши работы</Link></li>
              <li><Link href="/service/brochure" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Брошюра</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/about/careers" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Вакансии</Link></li>
              <li><Link href="/about/partnership" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Партнерство</Link></li>
              <li><Link href="/geography" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Работаем в городах</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/service/installment" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Рассрочка</Link></li>
              <li><Link href="/service/returns" className="text-gray-300 hover:text-[#62bb46] text-sm transition-colors">Возврат товара</Link></li>
            </ul>
          </div>

          {/* Column 5 - Contacts */}
          <div>
            <div className="text-gray-300 text-sm mb-3">с 07:00 до 20:00 мск</div>
            ...
            <div className="flex gap-2">
              ...
              <a href="https://rutube.ru/channel/e1shkafy" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#4d4d4d] rounded flex items-center justify-center text-gray-300 hover:bg-[#62bb46] hover:text-white transition-colors" title="Rutube">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
