...
interface DirectorContactModalProps {
  isOpen: boolean;
  onClose: () => void;
}

export default function DirectorContactModal({ isOpen, onClose }: DirectorContactModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/contact-director', {
        method: 'POST',
        headers: {
      ...
      setSubmitStatus('error');
      setErrorMessage('Не удалось отправить обращение. Пожалуйста, попробуйте позже.');
    } finally {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6 pt-8">
          ...
          <div className="text-center mb-6">
            ...
            <h2 className="text-2xl font-bold text-[#3d4543]">Связь с директором</h2>
            <p className="text-gray-500 mt-2">
              Напишите нам и мы обязательно рассмотрим ваше обращение
            </p>
          </div>
          ...
          {submitStatus === 'success' ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-bold text-[#3d4543] mb-2">Обращение отправлено!</h3>
              <p className="text-gray-500 mb-6">
                Директор рассмотрит ваше обращение в ближайшее время
              </p>
              <button
                onClick={handleClose}
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              {/* Name field */}
              <div>
                <label htmlFor="director-name" className="block text-sm font-medium text-[#3d4543] mb-2">
              ...
              {/* Phone field */}
              <div>
                <label htmlFor="director-phone" className="block text-sm font-medium text-[#3d4543] mb-2">
              ...
              {/* Message field */}
              <div>
                <label htmlFor="director-message" className="block text-sm font-medium text-[#3d4543] mb-2">
              ...
              <div className="flex items-start gap-3">
                ...
                />
                <label htmlFor="director-privacy" className="text-sm text-gray-600 cursor-pointer">
                  Я согласен на{' '}
                  <Link
                    href="/privacy-policy"
